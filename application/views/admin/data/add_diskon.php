								...
								<div class="card card-statistics Multi-sel">
									<div class="card-header">
										<div class="card-heading">
											<h4 class="card-title">Form add diskon</h4>
										</div>
									</div>
									<div class="card-body">
										<form action="<?= base_url() . 'admin/diskon/save' ?>" method="post">
											<div class="col-md-12 form-grup mb-2 ">
												...
												<input required class="form-control" type="text" name="val_disc">
											</div>
											<div class="col-md-12  mb-2 ">
												<label>Discount Code</label>
												<div class="input-group">
													<input type="text" id="code" class="form-control" name="dist_code" required>
